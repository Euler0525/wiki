...
<img src="https://cdn.jsdelivr.net/gh/Euler0525/tube/windows/wifi2eth.webp" alt="wifi2eth" width="80%" />
...
校园网 iwd 配置文件，位于 `/var/lib/iwd/BIT-Mobile.8021x`，权限为 `600`
